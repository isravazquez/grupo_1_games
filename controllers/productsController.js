...
const productsController = {
  ...
  viewDetailProduct: (req, res) => {
    //apertura de archivo
    let listProducts = modelProducts.openFile();
  ...
  createProduct: (req, res) => {
    ...
    const products = modelProducts.writeProducts(req, res);
  ...
  updateProduct: (req, res) => {
    ...
    if (productE != null) {
      ...
      //escritura de archivo
      modelProducts.writeProducts(listProducts);

      //apertura de archivo
      listProducts = modelProducts.openFile();
